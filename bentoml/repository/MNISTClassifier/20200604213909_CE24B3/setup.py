...
setuptools.setup(
    ...
    version='20200604213909_CE24B3',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - MNISTClassifier:20200604213909_CE24B3
...
""",
    ...
    package_data={
        'MNISTClassifier': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'MNISTClassifier=MNISTClassifier:cli',
        ],
    }
)
